...
public class TeamFoundationServerScmTest {
    ...
    public void assertWorkspaceNameReplacesJobName() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, ".", false, "erik_${JOB_NAME}", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    public void assertDefaultValueIsUsedForEmptyLocalPath() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", "", false, "workspace", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    public void assertDefaultValueIsUsedForEmptyWorkspaceName() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", ".", false, "", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    public void assertGetModuleRootReturnsWorkFolder() throws Exception {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", "workfolder", false, "", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    public void assertWorkspaceNameIsAddedToEnvVars() throws Exception {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", ".", false, "WORKSPACE_SAMPLE", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
        AbstractBuild build = mock(AbstractBuild.class);
        AbstractProject project = mock(AbstractProject.class);
        when(build.getProject()).thenReturn(project);
    ...
    public void assertWorksfolderPathIsAddedToEnvVars() throws Exception {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", "PATH", false, "WORKSPACE_SAMPLE", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    public void assertWorkspaceNameReplacesInvalidChars() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, ".", false, "A\"B/C:D<E>F|G*H?I", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    public void assertWorkspaceNameReplacesEndingPeriod() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, ".", false, "Workspace.Name.", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    @Test public void assertServerUrlResolvesBuildVariables() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("https://${PARAM}.com", null, ".", false, "", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    @Test public void assertProjectPathResolvesBuildVariables() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, "$/$PARAM/path", ".", false, "", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    @Test public void assertWorkspaceNameResolvesBuildVariables() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, ".", false, "WS-${PARAM}", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
    ...
    @Test public void assertTfsWorkspaceIsntRemovedIfThereIsNoBuildWhenProcessWorkspaceBeforeDeletion() throws Exception {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("server", "projectpath", ".", false, "workspace", "user", "password", ServerConfigurationProvider.TFS_TEE_CLC_10, null, null);
